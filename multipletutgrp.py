...
num = int(input("Input number of students per team: "))
for tut_group, students in all_students.items():
    teams = form_teams(students, num)
    optimized_teams = optimize_teams(teams, calc_avg_cgpa(students), max_rounds=1000) # to get the whole tut grp's cgpa for compare
